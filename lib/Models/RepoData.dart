...
enum EventsUrl { HTTPS_API_GITHUB_COM_USERS_CLEMBABS_EVENTS_PRIVACY }

final eventsUrlValues = new EnumValues({
  "https://api.github.com/users/clembabs/events{/privacy}": EventsUrl.HTTPS_API_GITHUB_COM_USERS_CLEMBABS_EVENTS_PRIVACY
});

enum FollowingUrl { HTTPS_API_GITHUB_COM_USERS_CLEMBABS_FOLLOWING_OTHER_USER }

final followingUrlValues = new EnumValues({
  "https://api.github.com/users/clembabs/following{/other_user}": FollowingUrl.HTTPS_API_GITHUB_COM_USERS_CLEMBABS_FOLLOWING_OTHER_USER
});

enum GistsUrl { HTTPS_API_GITHUB_COM_USERS_CLEMBABS_GISTS_GIST_ID }

final gistsUrlValues = new EnumValues({
  "https://api.github.com/users/clembabs/gists{/gist_id}": GistsUrl.HTTPS_API_GITHUB_COM_USERS_CLEMBABS_GISTS_GIST_ID
});

enum Login { CLEMBABS }

final loginValues = new EnumValues({
  "clembabs": Login.CLEMBABS
});

enum NodeId { MDQ6_VX_NLCJ_Q5_NJC3_O_DK4 }

final nodeIdValues = new EnumValues({
  "MDQ6VXNlcjQ5Njc3ODk4": NodeId.MDQ6_VX_NLCJ_Q5_NJC3_O_DK4
});

enum StarredUrl { HTTPS_API_GITHUB_COM_USERS_CLEMBABS_STARRED_OWNER_REPO }

final starredUrlValues = new EnumValues({
  "https://api.github.com/users/clembabs/starred{/owner}{/repo}": StarredUrl.HTTPS_API_GITHUB_COM_USERS_CLEMBABS_STARRED_OWNER_REPO
});
